...
!function (e, t) {
...
}("undefined" != typetoastrof window ? window : this, function (e, t) {
    "use strict";
    ...
    function Ke(e, t, n) {
        var i = He(e), r = We(e, t, i), o = "border-box" === w.css(e, "boxSizing", !1, i), a = o;
        if (Me.test(r)) {
            if (!n) return r;
            r = "auto"
        }
    ...
    w.extend({
        ...
        w.cssHooks[t] = {
            get: function (e, n, i) {
                ...
                var r, o = He(e), a = "border-box" === w.css(e, "boxSizing", !1, o), s = i && Qe(e, t, i, a, o);
    ...
    var k = "carousel", O = ".bs.carousel", A = t.fn[k],
        ...
        }, H = "carousel", $ = "active", W = "slide", R = "carousel-item-right", q = "carousel-item-left",
        F = "carousel-item-next", B = "carousel-item-prev", V = "pointer-event", X = {
            ...
            return n.next = function () {
                ...
                if (e === N ? (i = q, r = F, o = L) : (i = R, r = B, o = j), u && t(u).hasClass($)) this._isSliding = !1; else if (!this._triggerSlideEvent(u, o).isDefaultPrevented() && s && u) {
                    ...
                    if (t(this._element).hasClass(W)) {
                        ...
                        t(s).one(c.TRANSITION_END, function () {
                            t(u).removeClass(i + " " + r).addClass($), t(s).removeClass($ + " " + r + " " + i), a._isSliding = !1, setTimeout(function () {
                                return t(a._element).trigger(h)
                            }, 0)
                        }).emulateTransitionEnd(g)
                    } else t(s).removeClass($), t(u).addClass($), this._isSliding = !1, t(this._element).trigger(h);
                    f && this.cycle()
                }
            }, e._jQueryInterface = function (n) {
                return this.each(function () {
    ...
    var Ne = t.fn.modal, Ie = {backdrop: !0, keyboard: !0, focus: !0, show: !0},
        ...
        }, Me = "modal-dialog-scrollable", He = "modal-scrollbar-measure", $e = "modal-backdrop", We = "modal-open",
        Re = "fade", qe = "show", Fe = {
            DIALOG: ".modal-dialog",
            ...
            return n.toggle = function (e) {
                ...
                if (this._isShown && this._config.backdrop) {
                    if (this._backdrop = document.createElement("div"), this._backdrop.className = $e, i && this._backdrop.classList.add(i), t(this._backdrop).appendTo(document.body), t(this._element).on(je.CLICK_DISMISS, function (e) {
    ...
    var Mt = t.fn.tab, Ht = {
        ...
        }, $t = "dropdown-menu", Wt = "active", Rt = "disabled", qt = "fade", Ft = "show", Bt = ".dropdown",
        ...
        Qt = "> .dropdown-menu .active", Kt = function () {
            ...
            return n.show = function () {
                ...
                if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && t(this._element).hasClass(Wt) || t(this._element).hasClass(Rt))) {
                    ...
                    var s = t.Event(Ht.HIDE, {relatedTarget: this._element}), l = t.Event(Ht.SHOW, {relatedTarget: i});
                    if (i && t(i).trigger(s), t(this._element).trigger(l), !l.isDefaultPrevented() && !s.isDefaultPrevented()) {
                        ...
                        var u = function () {
                            var n = t.Event(Ht.HIDDEN, {relatedTarget: e._element}),
                                r = t.Event(Ht.SHOWN, {relatedTarget: i});
                ...
                if (t(e).addClass(Wt), "tab" === e.getAttribute("role") && e.setAttribute("aria-selected", !0), c.reflow(e), e.classList.contains(qt) && e.classList.add(Ft), e.parentNode && t(e.parentNode).hasClass($t)) {
    ...
    t(document).on(Ht.CLICK_DATA_API, Ut, function (e) {
            ...
            var w = function () {
                        ...
                        if ("scroll" === E) {
                            ...
                            for (var I in o(a).tweensContainer && !0 === o(a).isAnimating && (D = o(a).tweensContainer), u.each(y, function (e, t) {
                                ...
                                if (o(a).isSVG || "tween" === R || !1 !== b.Names.prefixCheck(R)[1] || b.Normalizations.registered[R] !== i) {
                                    ...
                                    var F, B, V, X = !1;
                                    if (W = (F = p(I, W))[0], V = F[1], H = (F = p(I, H))[0].replace(/^([+-\/*])=/, function (e, t) {
                                            return X = t, ""
                                        }), B = F[1], W = parseFloat(W) || 0, H = parseFloat(H) || 0, "%" === B && (/^(fontSize|lineHeight)$/.test(I) ? (H /= 100, B = "em") : /^scale/.test(I) ? (H /= 100, B = "") : /(Red|Green|Blue)$/i.test(I) && (H = H / 100 * 255, B = "")), /[\/*]/.test(X)) B = V; else if (V !== B && 0 !== W) if (0 === H) B = V; else {
                                        r = r || g();
                ...
                if (h.isWrapped(this) ? (d = !1, p = 0, m = this, f = this) : (d = !0, p = 1, m = x ? arguments[0].elements || arguments[0].e : arguments[0]), m = r(m)) {
                    ...
                    if (u.each(m, function (e, t) {
                        ...
                        var H = {delay: I.delay, progress: I.progress};
                        M === N - 1 && (H.display = I.display, H.visibility = I.visibility, H.complete = I.complete), w(m, "reverse", H)
                    }
                    return e()
                }
            };
        ...
        return function () {
            var t, n, i, r = 0, o = {error: "error", info: "info", success: "success", warning: "warning"}, a = {
                clear: function (n, i) {
                    ...
                    return u({type: o.info, iconClass: d().iconClasses.info, message: e, optionsOverride: n, title: t})
            ...
            key: "openOnClick", value: function () {
                ...
                this.$element.on("click", function (n) {
                    if (n.preventDefault(), !0 === t.menuOut) t.menuOut = !1, t.removeMenu(); else {
                        t.menuOut = !0, t.$sidenavOverlay = e('<div id="sidenav-overlay"></div>'), t.$body.append(t.$sidenavOverlay);
                        var i = [];
...
}, {}, [1]), $.fn.mdbAutocomplete = function (e) {
    return e = $.extend({
        data: {},
        dataColor: "",
        xColor: "",
        ...
        var i, r = $(n), o = e.data, a = e.dataColor, s = e.xColor, l = e.xBlurColor, c = e.inputFocus, u = e.inputBlur,
            d = e.inputFocusShadow, f = e.inputBlurShadow;
        Object.keys(o).length && (i = $('<ul class="mdb-autocomplete-wrap"></ul>')).insertAfter(r), r.on("focus", function () {
            r.css("border-bottom", c), r.css("box-shadow", d)
        }), r.on("blur", function () {
            r.css("border-bottom", u), r.css("box-shadow", f)
        }), r.on("keyup", function (e) {
            var t = r.val();
            if (i.empty(), t.length) for (var n in o) if (-1 !== o[n].toLowerCase().indexOf(t.toLowerCase())) {
                var s = $("<li>".concat(o[n], "</li>"));
                i.append(s)
            }
            13 === e.which && (i.children(":first").trigger("click"), i.empty()), 0 === t.length ? r.parent().find(".mdb-autocomplete-clear").css("visibility", "hidden") : r.parent().find(".mdb-autocomplete-clear").css("visibility", "visible"), $(".mdb-autocomplete-wrap li").css("color", a)
        }), i.on("click", "li", function (e) {
            r.val($(e.target).text()), i.empty()
        }), $(".mdb-autocomplete-clear").on("click", function (e) {
            e.preventDefault();
            var t = $(e.currentTarget);
            t.parent().find(".mdb-autocomplete").val(""), t.css("visibility", "hidden"), i.empty(), t.parent().find("label").removeClass("active")
        }), $(".mdb-autocomplete").on("click keyup", function (e) {
            e.preventDefault(), $(e.target).parent().find(".mdb-autocomplete-clear").find("svg").css("fill", s)
        }), $(".mdb-autocomplete").on("blur", function (e) {
            e.preventDefault(), $(e.target).parent().find(".mdb-autocomplete-clear").find("svg").css("fill", l)
        })
    })
}, $.fn.mdb_autocomplete = $.fn.mdbAutocomplete, function (e) {
