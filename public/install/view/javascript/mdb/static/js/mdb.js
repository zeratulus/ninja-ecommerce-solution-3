            ...
            var x = function () {
                    ...
                    function t(t) {
                        ...
                        if ("scroll" === M) {
                            ...
                            for (var O in a(r).tweensContainer && !0 === a(r).isAnimating && (D = a(r).tweensContainer), u.each(y, function (t, e) {
                                ...
                                var F = h(y[O]), W = F[0], V = F[1], z = F[2];
                                O = b.Names.camelCase(O);
                                var N = b.Hooks.getRoot(O), H = !1;
                                if (a(r).isSVG || "tween" === N || !1 !== b.Names.prefixCheck(N)[1] || b.Normalizations.registered[N] !== n) {
                                    ...
                                    if (z = (B = p(O, z))[0], Y = B[1], W = (B = p(O, W))[0].replace(/^([+-\/*])=/, function (t, e) {
                                            return $ = e, ""
                                        }), j = B[1], z = parseFloat(z) || 0, W = parseFloat(W) || 0, "%" === j && (/^(fontSize|lineHeight)$/.test(O) ? (W /= 100, j = "em") : /^scale/.test(O) ? (W /= 100, j = "") : /(Red|Green|Blue)$/i.test(O) && (W = W / 100 * 255, j = "")), /[\/*]/.test($)) j = Y; else if (Y !== j && 0 !== z) if (0 === W) j = Y; else {
                                        o = o || m();
                ...
                if (f.isWrapped(this) ? (d = !1, p = 0, g = this, h = this) : (d = !0, p = 1, g = k ? arguments[0].elements || arguments[0].e : arguments[0]), g = o(g)) {
                    ...
                    if (u.each(g, function (t, e) {
                            f.isNode(e) && r.call(e)
                        }), (O = u.extend({}, v.defaults, w)).loop = parseInt(O.loop), E = 2 * O.loop - 1, O.loop) for (var F = 0; E > F; F++) {
        ...
        1: [function (t, e, i) {
                ...
                defaults: {}, addBox: function (t, e) {
                    ...
                    if (t) {
                        var r = t.options.layout || {}, s = n.options.toPadding(r.padding), l = s.left, c = s.right,
                            u = s.top, d = s.bottom, h = o(t.boxes, "left"), f = o(t.boxes, "right"),
                            p = o(t.boxes, "top"), m = o(t.boxes, "bottom"), g = o(t.boxes, "chartArea");
                        a(h, !0), a(f, !1), a(p, !0), a(m, !1);
                        var v = e - l - c, y = i - u - d, b = y / 2, x = (e - v / 2) / (h.length + f.length),
                            w = (i - b) / (p.length + m.length), k = v, C = y, S = [];
                        ...
                        if (o.display) {
                            ...
                            if (a.each(g, function (i, n) {
                                    if (!a.isNullOrUndef(i.label)) {
                                        ...
                                        var F = "middle", W = "middle", V = u.padding;
                                        if (m) {
                                            var z = w + V;
                                ...
                                var E, O, L = 0, R = r(f) / 2;
                                if (m) E = e.left + (e.right - e.left) / 2, O = "bottom" === o.position ? e.bottom - R - S.bottom : e.top + R + S.top; else {
                            ...
                            if (h.drawBorder) {
                                ...
                                var W = e.left, V = e.right + I, z = e.top, N = e.bottom + I,
            ...
            n._set("global", {
                ...
                t.Tooltip = o.extend({
                    initialize: function () {
                        ...
                        if ("center" === h) s = p + g / 2, "left" === d ? (o = (n = f) - c, a = n, r = s + c, l = s - c) : (o = (n = f + m) + c, a = n, r = s - c, l = s + c); else if ("left" === d ? (n = (o = f + u + c) - c, a = o + c) : "right" === d ? (n = (o = f + m - u - c) - c, a = o + c) : (n = (o = i.caretX) - c, a = o + c), "top" === h) s = (r = p) - c, l = r; else {
                            s = (r = p + g) + c, l = r;
                            var v = a;
                            a = n, n = v
                        }
            ...
            e.exports = {
                id: "filler", afterDatasetsUpdate: function (t, e) {
                    var i, n, a, r, d = (t.data.datasets || []).length, h = e.propagate, f = [];
                    ...
                    if (i) {
                        ...
                        c && u && l.length && (a.canvas.clipArea(o, t.chartArea), function (t, e, i, n, o, a) {
                            var r, s, l, c, u, f, p, m = e.length, g = n.spanGaps, v = [], y = [], b = 0, x = 0;
            ...
            var c = o.extend({
                initialize: function (t) {
                    ...
                    if (g ? (m.width = t.maxWidth, m.height = o ? 10 : 0) : (m.width = o ? 10 : 0, m.height = t.maxHeight), o) if (r.font = f, g) {
                    ...
                    if (e.display) {
                        ...
                        var y = l(i, p), b = t.legendHitBoxes, x = t.isHorizontal();
            ...
            var l = o.extend({
                ...
                draw: function () {
                    ...
                    if (o.display) {
                        ...
                        var w = o.text;
                        if (a.isArray(w)) for (var k = 0, C = 0; C < w.length; ++C) e.fillText(w[C], 0, k, s), k += p; else e.fillText(w, 0, 0, s);
                        e.restore()
                    }
                }
            });
                            ...
                            o.each(t.ticks, function (i, s) {
                                ...
                                for (var p = r(t) - 1; p >= 0; p--) {
                                    ...
                                    if (l.display) {
                                        ...
                                        var y = t.getIndexAngle(p), b = o.toDegrees(y);
            ...
            e.exports = function (t) {
                var e = t.Scale.extend({
                    initialize: function () {
                        ...
                        var t, e, i, o, l, c, h = this, f = h.chart, m = h.options.time, g = m.unit || "day", v = s,
                            y = r, b = [], x = [], w = [];
                        for (t = 0, i = f.data.labels.length; t < i; ++t) w.push(p(f.data.labels[t], h));
                        for (t = 0, i = (f.data.datasets || []).length; t < i; ++t) if (f.isDatasetVisible(t)) if (l = f.data.datasets[t].data, a.isObject(l[0])) for (x[t] = [], e = 0, o = l.length; e < o; ++e) c = p(l[e], h), b.push(c), x[t][e] = c; else b.push.apply(b, w), x[t] = w.slice(0); else x[t] = [];
...
dropdownSelectors.on({
    ...
    var E = "ontouchstart" in t, O = A(t, "PointerEvent") !== n,
        L = E && /mobile|tablet|ip(ad|hone|od)|android/i.test(navigator.userAgent), R = 25, F = 1, W = 2, V = 4, z = 8,
        N = 1, H = 2, B = 4, j = 8, Y = 16, $ = H | B, X = j | Y, q = $ | X, U = ["x", "y"], Q = ["clientX", "clientY"];
    ...
    function G(t, e, i) {
        var o = i.pointers.length, a = i.changedPointers.length, r = e & F && o - a == 0, s = e & (V | z) && o - a == 0;
    ...
    var ot = {mousedown: F, mousemove: W, mouseup: V}, at = "mousedown", rt = "mousemove mouseup";
    ...
    var lt = {pointerdown: F, pointermove: W, pointerup: V, pointercancel: z, pointerout: z},
    ...
    var ft = {touchstart: F, touchmove: W, touchend: V, touchcancel: z}, pt = "touchstart",
    ...
    var vt = {touchstart: F, touchmove: W, touchend: V, touchcancel: z},
    ...
    var Ot = 1, Lt = 2, Rt = 4, Ft = 8, Wt = Ft, Vt = 16;
    ...
    zt.prototype = {
        ...
        defaults: {event: "press", pointers: 1, time: 251, threshold: 9}, getTouchAction: function () {
            ...
            if (this._input = t, !n || !i || t.eventType & (V | z) && !o) this.reset(); else if (t.eventType & F) this.reset(), this._timer = d(function () {
                this.state = Wt, this.tryEmit()
            }, e.time, this); else if (t.eventType & V) return Wt;
            return 32
        }, reset: function () {
        ...
        inputTarget: null,
        inputClass: null,
        preset: [[qt, {enable: !1}], [$t, {enable: !1}, ["rotate"]], [Ut, {direction: $}], [Yt, {direction: $}, ["swipe"]], [Qt], [Qt, {
            event: "doubletap",
            taps: 2
        }, ["tap"]], [Xt]],
        cssProps: {
...
!function (t) {
    ...
    var e = "input[type=range]", i = !1, n = void 0;
    t(document).on("change", e, function () {
        ...
        var o = t(this).children(".thumb"), a = void 0;
        if (i) {
    ...
    function S(t, e) {
        ...
        if (e.twelvehour) for (E = 0; E < 12; E += e.hourstep) O = F.clone(), L = E / 6 * Math.PI, R = y, O.css("font-size", "140%"), O.css({
            left: v + Math.sin(L) * R - x,
            top: v - Math.cos(L) * R - x
        }), O.html(0 === E ? 12 : E), f.append(O), O.on(u, z); else for (E = 0; E < 24; E += e.hourstep) {
        ...
        for (E = 0; E < 60; E += V) for (E = 0; E < 60; E += 5) O = F.clone(), L = E / 30 * Math.PI, O.css({
        ...
        if (l.on(u, function (t) {
            ...
            var N = r.find(".clockpicker-canvas"), H = p("svg");
    ...
    return function (t, e, i, n) {
        ...
        o.extend(r, n);
        var s, l, c, u, d, h, f, p, m, g, v, y, b, x, w, k, C, S, T, M, I, P, A, D, _, E, O, L, R, F, W, V, z, N, H, B,
            j, Y, $, X, q, U, Q, Z, G, K, J, tt, et, it, nt, ot, at, rt, st, lt = {x: 0, y: 0}, ct = {x: 0, y: 0},
            ...
            xt = function (t, e) {
                ...
                shout: St, listen: Ct, viewportSize: dt, options: r, isMainScrollAnimating: function () {
                    ...
                    if (!s && !l) {
                        ...
                        }(), m = {resize: a.updateSize, scroll: jt, keydown: Ht, click: Bt};
            ...
            le = 0, ce = {x: 0, y: 0}, ue = {x: 0, y: 0}, de = {x: 0, y: 0}, he = function (t, e) {
                ...
                if (Y) {
                    var n = Se(t);
                    if (it || q || G) Z = n; else if (ce.x !== pt.x * ht) it = "h"; else {
                ...
                var c = -1;
                if (0 === l && (Y = !1, o.unbind(window, f, a), fe(), G ? c = 0 : -1 !== le && (c = Tt() - le)), le = 1 === l ? Tt() : -1, n = -1 !== c && 150 > c ? "zoom" : "swipe", G && 2 > l && (G = !1, 1 === l && (n = "zoomPointerUp"), St("zoomGestureEnded")), Z = null, q || X || et || B) if (Ut(), N || (N = De()), N.calculateSwipeSpeed("x"), B) if (xe() < r.verticalDragRange) a.close(); else {
                    var u = ut.y, d = at;
            ...
            publicMethods: {
                lazyLoadItem: function (t) {
                    ...
                    if (l) {
                        ...
                        if (!l.src && l.html && (l.html.tagName ? c.appendChild(l.html) : c.innerHTML = l.html), Ue(l), $e(l, dt), !l.src || l.loadError || l.loaded) l.src && !l.loadError && ((n = o.createEl("pswp__img", "img")).style.opacity = 1, n.src = l.src, Qe(l, n), Xe(0, l, c, n)); else {
    ...
    return function (t, e) {
        ...
        x.init = function () {
            ...
            }), d("parseVerticalMargin", V), function () {
...
initPhotoSwipeFromDOM(".mdb-lightbox"), function (t) {
    ...
    (function (t) {
        ...
        var u = function () {
            ...
            return !1
        }(), d = void 0, h = void 0, f = void 0, p = !1, m = !1;
        ...
        function b() {
            if (v.length) {
                ...
                var t = p || !y || y.width !== d || y.height !== h, e = m || t || !y || y.y !== f;
        ...
        var x = !!t.ResizeObserver && new t.ResizeObserver(function (t) {
            ...
            return o(t, [{
                ...
                key: "init", value: function () {
                    ...
                    if ("static" === this.css(this.$item, "position") && this.css(this.$item, {position: "relative"}), "auto" === this.css(this.$item, "z-index") && this.css(this.$item, {zIndex: 0}), this.image.$container = document.createElement("div"), this.css(this.image.$container, t), this.css(this.image.$container, {"z-index": this.options.zIndex}), this.image.$container.setAttribute("id", "jarallax-container-" + this.instanceID), this.$item.appendChild(this.image.$container), this.image.useImgTag ? e = this.extend({
                ...
                key: "onScroll", value: function (t) {
                    ...
                    if (this.options.elementInViewport && (a = this.options.elementInViewport.getBoundingClientRect()), this.isElementInViewport = a.bottom >= 0 && a.right >= 0 && a.top <= h && a.left <= d, t || this.isElementInViewport) {
                        var r = Math.max(0, i), s = Math.max(0, n + i), l = Math.max(0, -i), c = Math.max(0, i + n - h),
                            u = Math.max(0, n - (i + n - h)), f = Math.max(0, -i + h - n),
                            p = 1 - 2 * (h - i) / (h + n), m = 1;
            ...
            for (var e = arguments[1], i = Array.prototype.slice.call(arguments, 2), n = t.length, o = 0, r = void 0; o < n; o++) if ("object" === (void 0 === e ? "undefined" : a(e)) || void 0 === e ? t[o].jarallax || (t[o].jarallax = new k(t[o], e)) : t[o].jarallax && (r = t[o].jarallax[e].apply(t[o].jarallax, i)), void 0 !== r) return r;
            return t
        };
    ...
    "use strict";
    var n = s(i(3)), o = s(i(0)), a = s(i(1)), r = s(i(10));
    ...
    var r = 0, s = 0, l = 0, c = 0, u = 0, d = new a, h = new a, f = function () {
        function t(e, i) {
            !function (t, e) {
                if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function")
            }(this, t);
