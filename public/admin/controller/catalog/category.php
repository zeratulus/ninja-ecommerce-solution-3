...
class ControllerCatalogCategory extends \Ninja\NinjaController {
	private $error = array();
	...
	protected function getList() {
		...
		$data['text_statuses'] = array(
            $this->language->get('text_disabled_short'),
            $this->language->get('text_enabled_short')
        );
        ...
        $data['href_ajax_update_status'] = $this->url->link('catalog/category/updateStatus', 'user_token=' . $this->session->data['user_token'], true);
        $data['href_ajax_update_noindex'] = $this->url->link('catalog/category/updateNoIndex', 'user_token=' . $this->session->data['user_token'], true);
    ...
    public function updateStatus()
    {
        ...
        if ($this->request->server['REQUEST_METHOD'] == 'POST') {
            $category_id = $this->request->isset_post('category_id');
            $status = $this->request->isset_post('status');

            if (!empty($category_id)) {
                $this->load->model('catalog/category');
                if ($this->model_catalog_category->updateStatus($category_id, $status)) {
                    $isError = false;
                }
            }
        }
    ...
    public function updateNoIndex()
    {
        ...
        if ($this->request->server['REQUEST_METHOD'] == 'POST') {
            ...
            if (!empty($category_id)) {
                $this->load->model('catalog/category');
                if ($this->model_catalog_category->updateNoIndex($category_id, $status)) {
                    $isError = false;
                }
            }
        }
    ...
    public function categories_list()
    {
        ...
        return $this->model_catalog_category->getCategoriesList();
    }
