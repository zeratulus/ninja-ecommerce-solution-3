...
class ControllerCatalogReview extends \Ninja\NinjaController
{
    private $error = array();
    ...
    protected function getList()
    {
        ...
        foreach ($results as $result) {
            if (!empty($result['avatar'])) {
                $image = $this->model_tool_image->resize("avatars/product/{$result['avatar']}", 60, 60);
            } else {
    ...
    protected function getForm()
    {
        ...
        $this->document->addScript('view/javascript/jquery/jquery-bar-rating/jquery.barrating.min.js');
        $this->document->addStyle('view/javascript/jquery/jquery-bar-rating/themes/fontawesome-stars.css');
        ...
        if (!empty($review_info['avatar'])) {
            $data['avatar'] = $this->model_tool_image->resize("avatars/product/{$review_info['avatar']}", 300, 300);
        } else {
