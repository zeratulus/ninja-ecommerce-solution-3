...
class ControllerCatalogManufacturer extends \Ninja\NinjaController {
	private $error = array();
...
//        if (empty($start = $this->getRequest()->isset_get('start'))) $start = 0;
//        if (empty($limit = $this->getRequest()->isset_get('limit')) || (int)$limit > 100) $limit = 100;
//
//        $filter = array(
//            'start' => $start,
//            'limit' => $limit
...
//        $results = $this->model_catalog_manufacturer->getManufacturers($filter);
        ...
        $results = $this->model_catalog_manufacturer->getManufacturersList();
