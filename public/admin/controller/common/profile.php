<?php
class ControllerCommonProfile extends \Ninja\AdminController {
	private $error = array();
	...
	public function index() {
		...
		if (isset($user_info['language_id']) && !empty($user_info['language_id'])) {
			$data['user_language_id'] = $user_info['language_id'];
		} else {
			$code = $this->getConfig()->get('config_admin_language');
			foreach ($data['languages'] as $language) {
				if ($language['code'] == $code) {
					$data['user_language_id'] = $language['language_id'];
					break;
				}
			}
		}
