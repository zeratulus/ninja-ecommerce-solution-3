<?php
class ControllerCommonLogin extends \Ninja\AdminController
{
	private $error = array();

    public function index() {

        if ( ($this->getRequest()->server['HTTPS'] == false) && ($this->getConfig()->get('config_secure')) ) {
            $this->getResponse()->redirect($this->getUrl()->link('common/login', '', true));
        }
