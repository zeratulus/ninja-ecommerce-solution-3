...
class ControllerBlogSetting extends \Ninja\NinjaController {
	private $error = array();
	...
	public function index() {
        ...
        //Language Support for Blog
        $settingsRenderer = new \Tools\Monsters\Language\Twig\FormRenderer\FormRendererBootstrap($this->registry);

        $tabGeneral = $settingsRenderer->tabs->addTab('tab-general', $this->getLanguage()->get('tab_general'));
//        $tabGeneral = $settingsRenderer->tabs->getTabByIdx('tab-general');

        $tabGeneral->addControl('input', 'text', 'configblog_name',
            $this->getLanguage()->get('entry_name'),
            'input-name',
            !empty($this->error['configblog_name']),
            (!empty($this->error['configblog_name']) ? $this->error['configblog_name'] : '')
        );
...
//		}
        ...
        $tabGeneral->addControl('input', 'text', 'configblog_html_h1',
            $this->getLanguage()->get('entry_html_h1'),
            'input-h1'
        );
...
//		}
        ...
        $tabGeneral->addControl('input', 'text', 'configblog_meta_title',
...
//		}
        ...
        $tabGeneral->addControl('textarea', '', 'configblog_meta_description',
            $this->getLanguage()->get('entry_meta_description'),
...
//		}
        ...
        $tabGeneral->addControl('textarea', '', 'configblog_meta_keyword',
            $this->getLanguage()->get('entry_meta_keyword'),
            'input-meta-keyword'
        );

        $data['general_tabs'] = $settingsRenderer->generateLanguagesTabs('tab-general');
        $data['general_data'] = $settingsRenderer->generateFormElements('tab-general');
