...
class ModelBlogReview extends Model {
	...
	public function getReviews($data = array()) {
		$sql = "SELECT r.review_article_id, pd.name, r.avatar, r.author, r.rating, r.status, r.date_added FROM " . DB_PREFIX . "review_article r LEFT JOIN " . DB_PREFIX . "article_description pd ON (r.article_id = pd.article_id) WHERE pd.language_id = '" . (int)$this->config->get('config_language_id') . "'";
