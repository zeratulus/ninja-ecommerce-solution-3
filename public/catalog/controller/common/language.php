...
class ControllerCommonLanguage extends Controller {
	...
	public function language() {
		...
		if (isset($this->request->post['redirect'])) {
			...
			$redirect = $this->clean_get_lang($redirect);
	...
	private function seo_language() {
		...
		if (isset($this->request->post['redirect'])) {
			...
			$redirect_data = $this->clean_get_lang($redirect_data);
	...
	//clean autoswitch for alter lang link tags
	private function clean_get_lang($redirect) {
		//remove lang param from redirect on switch if it exists
		$redirect_data = $redirect;
		if (strpos($redirect_data,'lang') !== false) {
			$code = getUrlParamValue($redirect_data,'lang');
			$redirect_data = str_replace("lang={$code}", '', $redirect_data);
		}
