...
class ControllerInformationContact extends \Ninja\NinjaController
{
    private $error = array();
    ...
    public function index()
    {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
            ...
            $mail->setFrom($this->getRequest()->issetPost('email'));
        ...
        $data['store'] = $this->config->get('config_name' . $this->language_id);
        ...
        $data['open'] = nl2br($this->config->get('config_open' . $this->language_id));
        $data['comment'] = $this->config->get('config_comment' . $this->language_id);
