...
class ControllerBlogLatest extends \Ninja\NinjaController {
	public function index() { 
		...
		$configblog_html_h1 = $this->config->get('configblog_html_h1' . $this->language_id);
		...
		$configblog_meta_title = $this->config->get('configblog_meta_title' . $this->language_id);
		...
		$this->document->setDescription($this->config->get('configblog_meta_description' . $this->language_id));
		$this->document->setKeywords($this->config->get('configblog_meta_keyword' . $this->language_id));
		...
		foreach ($results as $result) {
            if ($result['image']) {
                $image = $this->model_tool_image->resizeBanner($result['image'], $this->config->get('configblog_image_article_width'), $this->config->get('configblog_image_article_height'));
            } else {
                $image = false;
            }
