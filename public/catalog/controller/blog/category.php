...
class ControllerBlogCategory extends \Ninja\NinjaController {
...
//                $data['thumb'] = 'image/'. $category_info['image'];
				$data['thumb'] = $this->model_tool_image->resizeBanner($category_info['image'], $this->config->get('configblog_image_category_width'), $this->config->get('configblog_image_category_height'));
			} else {
				$data['thumb'] = '';
			}
			...
			foreach ($results as $result) {
				if ($result['image']) {
					...
					$image = $this->model_tool_image->resizeBanner('placeholder.png', $this->config->get('configblog_image_article_width'), $this->config->get('configblog_image_article_height'));
				}
