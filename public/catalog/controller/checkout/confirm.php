...
class ControllerCheckoutConfirm extends \Ninja\NinjaController
{
    private const ROUTE = 'checkout/confirm';
    ...
    public function index()
    {
        ...
        if (!$redirect) {
            ...
            $order_data['invoice_prefix'] = $this->getConfig()->get('config_invoice_prefix');
            $order_data['store_id'] = $this->getConfig()->get('config_store_id' . $this->language_id);
            $order_data['store_name'] = $this->getConfig()->get('config_name' . $this->language_id);
