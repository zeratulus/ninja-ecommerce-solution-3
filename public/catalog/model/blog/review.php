...
class ModelBlogReview extends Model {
	public function addReview($article_id, $data) {
		...
		$this->db->query("INSERT INTO " . DB_PREFIX . "review_article SET author = '" . $this->db->escape($data['name']) .
            "', customer_id = '" . (int)$this->customer->getId() .
            "', article_id = '" . (int)$article_id .
            "', text = '" . $this->db->escape($data['text']) .
            "', rating = '" . (int)$data['rating'] .
            "', date_added = NOW(), avatar = '" . $this->getDb()->escape($avatar) . "'");

		$review_id = $this->db->getLastId();


		//TODO: add mail sending via \Support\Mail
